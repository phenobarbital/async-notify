#!/usr/bin/env python3
"""
SDD Insight — async-notify internal AI-fluency + SDD-process analyzer.
...
analysis is preserved verbatim (Layer 1); async-notify adds a second, SDD-aware
...
# --------------------------------------------------------------------------- #
# SDD layer (async-notify internal) — process-discipline metrics from sdd/ artifacts
# --------------------------------------------------------------------------- #
#
