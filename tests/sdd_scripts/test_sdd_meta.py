...
def test_known_branches_contains_main_dev() -> None:
    """KNOWN_BRANCHES exposes exactly the two canonical SDD Git Flow branches."""
    from scripts.sdd.sdd_meta import KNOWN_BRANCHES

    assert KNOWN_BRANCHES == frozenset({"main", "dev"})
