...
description: >-
  Adversarial second-opinion subagent for the dev-loop flow (FEAT-375). Given a neutral brief — a diff, the linked requirements / acceptance criteria, and a review question — it produces an independent, read-only, advisory review. It never receives the primary agent's reasoning or preferred conclusion
subagent: true
mainAgent: false
model: inherit
---
