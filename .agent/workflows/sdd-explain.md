---
description: Explain how a subsystem, component, or symbol works in the current project, grounded in the real codebase. Default mode produces an architecture walkthrough; pass --deep for a code-level implementation trace.
---
